    ...
    return (
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-slate-200 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 border rounded-xl bg-slate-100 text-slate-700 font-bold"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Pune, Mumbai, Nagpur, Nashik"
                className="w-full p-3 border rounded-xl"
              />
            </div>
          ...
          {/* Location Coordinates & Map Buttons */}
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-3">
            <span className="font-bold text-slate-800 text-xs block">Head Office Geo-Location Coordinates</span>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <input
                type="text"
                placeholder="Latitude (e.g., 18.5204)"
                value={formData.headOfficeLat}
                onChange={(e) => onChange({ headOfficeLat: e.target.value })}
                className="p-2.5 bg-white border rounded-xl font-mono"
              />
              <input
                type="text"
                placeholder="Longitude (e.g., 73.8567)"
                value={formData.headOfficeLng}
                onChange={(e) => onChange({ headOfficeLng: e.target.value })}
                className="p-2.5 bg-white border rounded-xl font-mono"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <button
                type="button"
                onClick={() => onChange({ headOfficeLat: '18.5204', headOfficeLng: '73.8567' })}
                className="px-3 py-1.5 bg-white border border-slate-300 hover:bg-slate-100 rounded-lg text-xs font-bold text-slate-700 cursor-pointer"
              >
                Select Location on Map
              </button>
              <button
                type="button"
                onClick={() => onChange({ headOfficeLat: '18.6298', headOfficeLng: '73.8131' })}
                className="px-3 py-1.5 bg-orange-50 border border-orange-200 text-[#ea580c] hover:bg-orange-100 rounded-lg text-xs font-bold cursor-pointer"
              >
